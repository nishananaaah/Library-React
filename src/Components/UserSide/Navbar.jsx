      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <form onSubmit={handleSearch} className="flex flex-1 mx-4 max-w-lg">
          <input
            ...
            className="w-full px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500"
          />
          <button
            type="submit"
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <ul className="absolute bg-white text-gray-800 mt-2 rounded-md shadow-lg w-48 z-10">
              {["Fiction", "Non-Fiction", "Mystery", "Childrensbook", "Romance", "Fantasy"].map(
                (category) => (
                  <li key={category}>
                    <button
          ...
          >
            Membership
              ...
              {/* Profile and Links */}
        <NavLink className="inline-block relative" onClick={toggleProfileDropdown}>
          <img
